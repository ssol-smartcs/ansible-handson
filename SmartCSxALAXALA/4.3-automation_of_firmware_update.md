...
|vars |Playbook例の値 |備考 | 
|:---|:---|:---|
|ttyno |'port01' |SmartCSの**TTY**番号を指定します |
|ftpserver |'192.168.127.2' |**RHEL IP**を指定します |
|ftpuser |'rhel01' |**RHELユーザのID**を指定します |
|ftppass |'secret01' |**RHELユーザのPass**を指定します |
|imgpath |'/home/rhel01' |/home/rhelXX 部分に**RHELユーザID**を指定します |

...
| vars | Playbook例の値 | 備考 | 
|:---|:---|:---|
| tty_no | 'port01' | SmartCSの**TTY**番号を指定します |
| ftp_server | '192.168.127.2' | **RHEL IP**を指定します |
| ftp_user | 'rhel01' | **RHELユーザのID**を指定します |
| ftp_password | 'secret01' | **RHELユーザのPass**を指定します |
| fwimg_path | '/home/rhel01' | /home/rhelXX 部分に**RHELユーザID**を指定します |

...
#### ユーザ毎の環境
本ワークショップでは、参加者一人につき1環境を提供しています。
...
### Step 2. RHELサーバーに接続する
各自のRHELサーバーに接続してください。

Windowsの場合は、TeraTerm や PuTTYなどのSSHクライアントを利用してください。

MacOS / Linuxの場合は、Terminalからそれぞれの環境に合わせて次のようなコマンドを実施してください。
環境ID：1の場合のコマンド例
```

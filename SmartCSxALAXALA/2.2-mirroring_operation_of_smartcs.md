...
※演習1.1に記載のTCPポート(SSH RW)を参考に、83xxというポート番号を指定してください。  
...
ポートユーザの認証には、ポートユーザのID、パスワードを入力してログインします。  
※ユーザ#1の場合はport01/secret01となります。  
※演習1.1に記載のポートユーザを参考に、ユーザ/パスワードを入力してください。  
...
※演習1.1に記載のTCPポート(SSH RO)を参考に、84xxというポート番号を指定してください。  

...
- [Step 3. <code>ios_config</code>と<code>loop</code>を使って、IOS装置に各種サーバーの設定を行う（NTP、SNMP、SYSLOG）](./2.2-additional_setup_the_ios_device.md#step-3-ios_configとloopを使ってIOS装置に各種サーバの設定を行うNTPSNMPSYSLOG)
<br>
<br>

...
```
[ec2-user@ip-172-26-10-114 ~]$ ssh portXX@192.168.129.1 -p 83XX
Console Server Authentication.
portXX@192.168.129.1's password:
```
...
```
[ec2-user@ip-172-26-10-114 ~]$ ssh user01@192.168.129.1
Console Server Authentication.
user01@192.168.129.1's password:
```

...
## 目次
本演習では以下を行います。 
- [Step 1. <code>ax_command</code>を使ってALAXALA装置の設定情報を取得する](./3.3-get_ios_device_information.md#step-1-ax_commandを使ってALAXALA装置の設定情報を取得する)
...
### Step 1. <code>ax_command</code>を使ってALAXALA装置の設定情報を取得する

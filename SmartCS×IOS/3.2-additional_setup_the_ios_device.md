...
## 目次
本演習では以下を行います。 
- STEP1. <code>ax_facts</code>を使って、IOS装置にAnsibleからアクセスできる事の確認を行う  
- STEP2. <code>ax_config</code>を使って、IOS装置にVLANの設定を行う  
- STEP3. <code>ax_config</code>と<code>with_items</code>を使って、IOS装置に各種サーバの設定を行う（NTP、SNMP、SYSLOG）  
...
### STEP2. <code>ios_config</code>を使って、IOS装置にVLANの設定を行う  
...
### STEP3. <code>ios_config</code>と<code>with_items</code>を使って、IOS装置に各種サーバの設定を行う（NTP、SNMP、SYSLOG）  

...
```bash
[ec2-user@ip-XXX-XXX-XXX-XXX ~]$ vi ios_show_version.yml
```
...
```bash
[ec2-user@ip-XXX-XXX-XXX-XXX ~]$ ansible-playbook ios_show_version.yml 
```
...
```bash
[ec2-user@ip-XXX-XXX-XXX-XXX ~]$ ansible-playbook ios_initial_setting_v1_user.yml 
```
<br>
...
```bash
[ec2-user@ip-XXX-XXX-XXX-XXX ~]$ ansible-playbook initial_setting_v2_ansible_reach.yml
```

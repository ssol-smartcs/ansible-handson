...
- [Step 2. <code>ax_command</code>をSmartCS経由で動作させるように変更する](./3.4-setting_of_ios_device_via_smartcs.md#step-2-ax_commandをSmartCS経由で動作させるように変更する)
...
### Step 2. ax_commandをSmartCS経由で動作させるように変更する

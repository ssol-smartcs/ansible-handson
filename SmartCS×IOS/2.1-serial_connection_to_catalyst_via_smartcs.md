[↑目次に戻る](./README.md)
<br>
# 演習2.1　SmartCSを介してcatalyst装置へコンソールアクセスする
演習2.1では、SmartCSを介してcatalyst装置へのコンソールアクセスを行います。
<br>
...
- STEP3. catalyst装置に対してコマンドを実行する
- STEP4. catalyst装置からログアウトする
...
|用語 |解説 |
|:---|:---|
|シリアルポート(tty) |ネットワーク機器のコンソールを接続するためのSmartCS側のポートです。本日のハンズオンではcatalyst装置のコンソールがSmartCSのシリアルポート1,9,17,25,33に接続されています。 |
...
### STEP2. SmartCSを介してcatalyst装置へログインする
ポートサーバーメニューからシリアルセッションを開始し、catalyst装置へログインを行います。
<br>
まず、<code>3  : start tty connection</code>を選択し、シリアルセッションを開始します。
<br>
続けてログインID（operator）を入力するとcatalyst装置にログインすることができます。
<br>
...
<br>
catalyst装置からのログアウトが完了したら、Ctrl+Aを入力してポートサーバーメニューに戻ります。
<br>
...
### 参考情報2. セレクトモード
本ハンズオンではダイレクトモードでcatalyst装置にアクセスを行いますが、SmartCSを介したもう1つのアクセス方法としてセレクトモードがあります。
<br>
...
[→演習2.2 SmartCSを介したcatalyst装置へのコンソールアクセスを、別セッションでミラーリングする](./2.2-mirroring_operation_of_smartcs.md)  
[↑目次に戻る](./README.md)
